...
# 추론 프로바이더(Inference Providers)를 통한 API 접근
...
## Azure
Hugging Face는 Azure와 협력하여 Azure AI Model Catalog를 통해 텍스트, 비전, 음성, 멀티모달 작업을 아우르는 가장 인기 있는 오픈소스 모델들을 고객 환경에 직접 제공합니다. 이를 통해 Azure의 엔터프라이즈급 인프라, 자동 확장, 모니터링을 활용하여 관리형 온라인 엔드포인트에 안전하게 배포할 수 있습니다.
